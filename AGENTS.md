...
- خبر کوهنوردی agent (GMT 00:00 / 06:00 / 12:00 / 18:00; World Climbing, UIAA, PlanetMountain, Climbing.com, Desnivel, UKClimbing news, Alpinist Newswire, ExplorersWeb, DAV/CAI expeditions, American Alpine Journal **2026** — complete Persian translations, never summaries; AAJ oldest-first, kickoff one then two per GMT slot → `_news/` after three review passes): `.cursor/skills/news-wire/SKILL.md` + `.cursor/automations/news-wire-prompt.md` + `.github/workflows/news-wire-agent.yml`
