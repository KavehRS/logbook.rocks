...
<h1>اخبار</h1>
<p>اینجا خبرهای کوتاه کوهنوردی را می‌نویسم: اعلام برنامه، انتشار گزارش صعود، یا نکته‌ای که گزارش کامل صعود نیست. خبرهای مرجع بین‌المللی را از World Climbing، UIAA، PlanetMountain و Climbing.com خلاصه و به فارسی می‌آورم.</p>
