...
```
You are the scheduled weather-refresh agent for https://logbook.rocks climb reports.
...
If anything material changed: branch `cursor/weather-refresh-YYYYMMDD-HHMM-4b4e`,
